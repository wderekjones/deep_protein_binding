...
parser.add_argument("--exp_name", type=str, help="name of the experiment to collect results",
                    default="binding_debug")
            ...
            if item == "args.csv":
                ...
                for chkpnt in os.listdir(args.exp_dir + "/" + dir + "/checkpoints"):
                    if "epoch{}".format(args.epoch) in chkpnt:
                        ...
                        os.system(
                            "sbatch -p {} --wrap 'source activate deep_protein_binding; export LD_PRELOAD=/home/wdjo224/anaconda3/lib/libstdc++.so.6.0.24; python test.py {} --model_path={} --pid={} --n_test_process={} --epoch={}'".format(
                                args.partition, args_string, model_path, pid, args.n_test_process, args.epoch))
